'''Prompt: You are given a circular lock with three wheels, each of which display the numbers 0 through 9 in order. Each of these wheels rotate clockwise and counterclockwise.
...
Note: Rather than simply return the number of steps and none, this code prints the full path, number of steps, and "cannot reach" if the end point is unreachable.'''
