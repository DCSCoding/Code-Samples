...
while(true) {
    		...
    		Path copy = Paths.get("C:\\Users\\d.sander\\Desktop\\MAL_Recorder\\MAL_Members_BACKUP.xlsx");
    		Path originalPath = Paths.get("C:\\Users\\d.sander\\Desktop\\MAL_Recorder\\MAL_Members.xlsx");
    ...
    public static void recordSeason(String urlS) throws IOException {
    	...
    	try {
    		...
    		ex.addInformationArray(season, titleStrings, date.format(System.currentTimeMillis()), memberStrings);
    		//report(titles);
	...
	public static void recordTop(String urlS, int start, int end, String sheetname) throws IOException{
    	...
    	try {
    		...
    		ex.addInformationArray(sheetname, rankings, date, titles);
	...
	String date = sdf.format(System.currentTimeMillis());
		...
		ex.addInformation(sheet, title, date, members);
	...
	private static void report(Exception e) {
		try {
	    	...
	    	Date date = new Date();
			BufferedWriter debug = new BufferedWriter(new FileWriter("C:\\Users\\d.sander\\Desktop\\MAL_Recorder\\debug.txt", true), 32768);
